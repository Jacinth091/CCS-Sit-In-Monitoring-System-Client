      ...
      <div className="bg-white rounded-3xl shadow-xl w-full max-w-md overflow-hidden animate-fade-in-up">
        ...
        <div className="px-8 py-5 border-b border-[#6A9AB0]/10 bg-[#EAD8B1]/10 flex items-center justify-between">
          <div>
            ...
            <p className="text-[10px] font-bold text-[#6A9AB0] mt-0.5 flex items-center gap-1.5">
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="space-y-4">
             <div className="flex items-center justify-between">
                <span className="text-[10px] font-bold text-[#3A6D8C] bg-[#3A6D8C]/5 px-3 py-1 rounded-full">Your Rating</span>
          ...
          <div className="space-y-4">
             <div className="flex items-center gap-3">
                ...
                <div>
                   <p className="text-[10px] font-bold text-[#6A9AB0]">Admin Remarks</p>
             ...
             {adminRemark ? (
                ...
                <div className="flex items-center gap-2 text-[#6A9AB0]/50 py-2">
                   ...
                   <p className="text-[10px] font-bold italic">No remarks from admin</p>
                </div>
             )}
          </div>
        </div>
        ...
        <div className="px-8 py-5 bg-gray-50/50 border-t border-[#6A9AB0]/10 flex justify-end">
          <button
            onClick={onClose}
            className="px-8 py-2.5 rounded-xl bg-[#001F3F] text-white text-xs font-bold hover:bg-[#3A6D8C] transition-all cursor-pointer shadow-md shadow-[#001F3F]/10"
          >
            Close
          </button>
        </div>
